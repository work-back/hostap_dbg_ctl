...
/* LYJ Patch Begin */
static int wpa_cli_cmd_dbg_ctl(struct wpa_ctrl *ctrl, int argc, char *argv[])
{
	return wpa_cli_cmd(ctrl, "DBG_CTL", 0, argc, argv);
}
/* LYJ Patch End */
...
/* LYJ Patch Begin */
	{ "dbg_ctl", wpa_cli_cmd_dbg_ctl, NULL,
	  cli_cmd_flag_none,
	  "<cmd> [<value>] = debug ctl\n"
	  "cmd = display the current value of this cmd" },
/* LYJ Patch end */
